...
async def create_and_run_tasks(task_inputs, work_fn, task_label):
    '''
...
def create_task_of_tasks(task_inputs, work_fn, task_label):
    '''
    Create subtasks for each input in task_inputs and return a task that will complete when all subtasks are complete.
    '''
    async def gather_results():
        results = []
        async for task_result in create_and_run_tasks(task_inputs, work_fn, task_label):
